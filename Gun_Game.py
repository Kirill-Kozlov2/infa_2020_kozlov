...
class ball():
    def __init__(self, x=40, y=450):
        ...
        self.vy = 0
        self.c = 80
        self.color = choice(['blue', 'yellow', 'red', 'black', 'pink', 'purple'])
...
class gun():
    def __init__(self):
        ...
        self.f2_on = 0
        self.an = 1
        self.id = canv.create_line(20, 450, 50, 420, width=8)
    ...
    while lop:  
        ...
        for b in balls:
            ...
            if t1.live == 0 and t2.live == 0:
                ...
                canv.itemconfig(screen1, text='Цель была уничтожена за ' + str(bullet) + ' выстрелов')
        canv.update()
        time.sleep(0.03)
        g1.targetting()
        g1.power_up()
